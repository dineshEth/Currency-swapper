  ...
  return (
    <div className='flex flex-col border-[1px] rounded-md px-2 py-1 m-2 border-white'>
      ...
      <div className='flex flex-row justify-between items-center'>
        ...
        readOnly={!allowed}
        className={`bg-transparent border-none outline-none ${allowed ? 'text-white' : 'text-pink-600'} font-bold`} />
        <select 
        onChange={handleCurrencySelection}
        className='bg-transparent px-2 text-white outline-none overflow-y-scroll no-scrollbar w-[70px]' name="currency" id="" value={label == 'From'? from : to}>
